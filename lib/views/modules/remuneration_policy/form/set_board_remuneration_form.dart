...
class SetBoardRemunerationForm extends StatefulWidget {
  final Board board;
  const SetBoardRemunerationForm({super.key,required this.board});

  static const routeName = '/SetBoardRemunerationForm';
  @override
  State<SetBoardRemunerationForm> createState() => _SetBoardRemunerationFormState();
}

class _SetBoardRemunerationFormState extends State<SetBoardRemunerationForm> {
                ...
                children: [
                  TableRow(
                    children: [
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: CustomText(text: "${widget.board.boardName}"),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: SizedBox(
    ...
    return Row(
      children: [
        Container(
            ...
            child: CustomText(
                text: 'Set Remuneration for ${widget.board.boardName}',
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Colors.white
            )
