...
import '../views/competition_member_with_related_parties_list_views.dart';
class CompetitionWithRelatedPartiesForm extends StatefulWidget {
  final String committeeId;
  const CompetitionWithRelatedPartiesForm({super.key, required this.committeeId});
  static const routeName = '/CompetitionWithRelatedPartiesForm';
  @override
  State<CompetitionWithRelatedPartiesForm> createState() => _CompetitionWithRelatedPartiesFormState();
}

class _CompetitionWithRelatedPartiesFormState extends State<CompetitionWithRelatedPartiesForm> {
  ...
  void initState() {
    ...
    if (provider.competitionsRelatedPartiesData != null && provider.competitionsRelatedPartiesData!.competitions != null) {
      ...
      Container(
          ...
          child: TextButton(
            onPressed: () {
              ...
              Navigator.pushNamed(context, CompetitionMemberWithRelatedPartiesListViews.routeName, arguments: {'committeeId': widget.committeeId});
  ...
  Future saveForm(String committeeId) async {
    ...
    try {
      ...
      // Submit to backend
      bool success = await provider.insertNewCompetitionsForRelatedParties(data);
