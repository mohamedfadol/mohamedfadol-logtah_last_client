...
class _CompetitionMemberWithRelatedPartiesListViewsState extends State<CompetitionMemberWithRelatedPartiesListViews> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          Navigator.push(context, MaterialPageRoute(builder: (context) => CompetitionWithRelatedPartiesForm(committeeId: this.widget.committeeId)));
        },
        child: CustomIcon(
          icon: Icons.add,
          size: 30.0,
                                            ...
                                            itemBuilder: (context) => [
                                              ...
                                              PopupMenuItem<int>(
                                                  ...
                                                  CustomElevatedButton(
                                                    ...
                                                    10.0,
                                                    callFunction: () {
                                                      dialogDeleteRelatedPartiesCompetition(competition);
                                                    },
                                                  )),
                                            ]),
                                      ),
  ...
  Future dialogDeleteRelatedPartiesCompetition(CompetitionRelatedPartiesModel competition) => showDialog(
                        ...
                        child: Row(
                          ...
                          children: [
                            ElevatedButton.icon(
                              ...
                              onPressed: () => removeCompetitionRelatedParties(competition),
  ...
  void removeCompetitionRelatedParties(CompetitionRelatedPartiesModel competition)async {
