...
import '../pdf_services/PdfDownloadButton.dart';
import '../pdf_services/competion_with_members_questions_pdf_views.dart';

class ViewCompetitionWithCompany extends StatefulWidget {
  final Member member;
  final String type;
  const ViewCompetitionWithCompany({super.key, required this.member, required this.type});

  @override
  State<ViewCompetitionWithCompany> createState() => _ViewCompetitionWithCompanyState();
}

class _ViewCompetitionWithCompanyState extends State<ViewCompetitionWithCompany> {
