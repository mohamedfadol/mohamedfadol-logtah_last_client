...
class CompetitionMemberQuestionnaireScreen extends StatefulWidget {
  final String committeeId;
  const CompetitionMemberQuestionnaireScreen({super.key, required this.committeeId});
  static const routeName = '/CompetitionQuestionnaireScreen';

  @override
  _CompetitionMemberQuestionnaireScreenState createState() => _CompetitionMemberQuestionnaireScreenState();
}

class _CompetitionMemberQuestionnaireScreenState extends State<CompetitionMemberQuestionnaireScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.initializeResponseControllers();
    });
  }
            ...
            child: Row(
              children: [
                Container(
                    ...
                    child: CustomText(
                        text: "Competition Questionnaire",
                        fontSize: 20,
                ...
                Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushNamed(context, CompetitionsQuestionsWithCompanyListViews.routeName, arguments: {'committeeId': widget.committeeId});
                      },
                      child: CustomText(
                        text: 'Back',
                        color: Colors.white,
      ...
      if (provider.isBack) {
        Future.delayed(Duration(seconds: 2), () {
          if (Navigator.canPop(context)) {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => CompetitionMemberQuestionnaireScreen(committeeId: widget.committeeId)));
                  ...
                  child: Form(
                    ...
                    child: Consumer<CompetitionProviderPage>(
                      builder: (context, provider, child) {
                        ...
                        if (provider.competitionsData!.competitions!.isEmpty) {
                          return Center(
                            child: CustomText(
                        ...
                        if (provider.textResponses.isEmpty) {
                          for (int i = 0; i < provider.competitionsData!.competitions!.length; i++) {
                            final competition = provider.competitionsData!.competitions![i];
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemCount: provider.competitionsData!.competitions!.length,
                              itemBuilder: (context, index) {
                                CompetitionModel question = provider.competitionsData!.competitions![index];
