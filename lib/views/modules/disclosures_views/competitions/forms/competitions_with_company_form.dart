...
class CompetitionsWithCompanyForm extends StatefulWidget {
  final String committeeId;
  const CompetitionsWithCompanyForm({super.key, required this.committeeId});
  static const routeName = '/CompetitionsForm';

  @override
  State<CompetitionsWithCompanyForm> createState() => _CompetitionsWithCompanyFormState();
}

class _CompetitionsWithCompanyFormState extends State<CompetitionsWithCompanyForm> {
  ...
  void initState() {
    ...
    if (provider.competitionsData != null && provider.competitionsData!.competitions != null) {
                        ...
                        SliverPersistentHeader(
                          ...
                          delegate: _StickyHeaderDelegate(
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  buildHeaderButtons(this.widget.committeeId),
                                ],
                              ),
                            ),
                            headerHeight: 70.0,
  ...
  Widget buildHeaderButtons(String committeeId) => Row(
    ...
    children: [
      Container(
          ...
          child: TextButton(
            onPressed: () {
              Navigator.pushNamed(context, CompetitionsQuestionsWithCompanyListViews.routeName, arguments: {'committeeId': committeeId});
            },
            child: CustomText(
              text: 'Back',
              color: Colors.white,
    ...
    try {
      ...
      if (success) {
        ...
        Future.delayed(const Duration(seconds: 2), () {
          if (Navigator.canPop(context)) {
            Navigator.pushReplacementNamed(context, CompetitionsQuestionsWithCompanyListViews.routeName);
          }
        });
      } else {
