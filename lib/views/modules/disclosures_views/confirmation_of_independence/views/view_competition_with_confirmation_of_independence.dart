...
class ViewCompetitionWithConfirmationOfIndependence extends StatefulWidget {
  final Member member;
  final String type;
  const ViewCompetitionWithConfirmationOfIndependence({super.key, required this.member, required this.type});

  @override
  State<ViewCompetitionWithConfirmationOfIndependence> createState() => _ViewCompetitionWithConfirmationOfIndependenceState();
}

class _ViewCompetitionWithConfirmationOfIndependenceState extends State<ViewCompetitionWithConfirmationOfIndependence> {
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: SingleChildScrollView(
                              child: DataTable(
                                ...
                                rows:
                                provider!.competitionsConfirmationOfIndependenceData!.competitions!
            ...
            child: Row(
              children: [
                Container(
                    ...
                    child: CustomText(
                        text:
                        'Competition with company for ${member.memberFirstName}',
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: Colors.white)),
                const SizedBox(
