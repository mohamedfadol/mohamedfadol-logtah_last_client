...
class CompetitionMemberWithConfirmationOfIndependenceViews extends StatefulWidget {
  ...
  static const routeName = '/CompetitionMemberWithConfirmationOfIndependenceViews';
  const CompetitionMemberWithConfirmationOfIndependenceViews({super.key, required this.committeeId});

  @override
  State<CompetitionMemberWithConfirmationOfIndependenceViews> createState() => _CompetitionMemberWithConfirmationOfIndependenceViewsState();
}

class _CompetitionMemberWithConfirmationOfIndependenceViewsState extends State<CompetitionMemberWithConfirmationOfIndependenceViews> {
  @override
  void initState() {
              ...
              child: Row(
                children: [
                  Container(
                      ...
                      child: CustomText(
                          text: 'Competition with Confirmation Of Independence',
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: Colors.white
                      )
