...
import 'competition_member_with_confirmation_of_independence_views.dart';

class CompetitionsQuestionsWithConfirmationOfIndependenceListViews extends StatefulWidget {
  const CompetitionsQuestionsWithConfirmationOfIndependenceListViews({super.key});
  static const routeName = '/CompetitionsQuestionsWithConfirmationOfIndependenceListViews';
  @override
  State<CompetitionsQuestionsWithConfirmationOfIndependenceListViews> createState() => _CompetitionsQuestionsWithConfirmationOfIndependenceListViewsState();
}

class _CompetitionsQuestionsWithConfirmationOfIndependenceListViewsState extends State<CompetitionsQuestionsWithConfirmationOfIndependenceListViews> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    print("CompetitionsQuestionsWithConfirmationOfIndependenceListViews $committeeId");
    return Scaffold(
      appBar: Header(context),
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          Navigator.push(context, MaterialPageRoute(builder: (context) => CompetitionsWithConfirmationOfIndependenceForm(committeeId: committeeId)));
        },
        child: CustomIcon(
          icon: Icons.add,
          size: 30.0,
              ...
              Center(
                child: Consumer<CompetitionProviderPage>(
                    builder: (context, provider, child) {
                      if (provider.competitionsConfirmationOfIndependenceData?.competitions == null) {
                        provider.getListOfCompetitionsQuestionnaireForConfirmationOfIndependence(provider.yearSelected, committeeId);
                        return buildLoadingSniper();
                      }
                      return provider.competitionsConfirmationOfIndependenceData!.competitions!.isEmpty
                          ? buildEmptyMessage(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: SingleChildScrollView(
                              child: DataTable(
                                ...
                                rows: provider!.competitionsConfirmationOfIndependenceData!.competitions!
                                    .map((CompetitionConfirmationOfIndependenceModel competition) =>
                                    DataRow(cells: [
              ...
              child: Row(
                children: [
                  Container(
                      ...
                      child: CustomText(
                          text: 'Competition Questions For Confirmation Of Independence',
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: Colors.white
                      )
                  ...
                  Container(
                    ...
                    child: DropdownStringList(
                      ...
                      onChanged: (String? newValue) async {
                        ...
                        await provider.getListOfCompetitionsQuestionnaireForConfirmationOfIndependence(provider.yearSelected, committeeId);
                      },
                      color: Colors.grey,
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      child: CustomText(
                        text: 'Competition Questionnaire For Member Confirmation Of Independence',
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => CompetitionMemberWithConfirmationOfIndependenceViews(committeeId: committeeId)));
                      },
                      child: CustomText(
                        text: 'Competition Members With Confirmation Of Independence',
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
