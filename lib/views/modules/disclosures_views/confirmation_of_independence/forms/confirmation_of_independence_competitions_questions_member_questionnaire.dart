...
class ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaire extends StatefulWidget {
  final String committeeId;
  const ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaire({super.key, required this.committeeId});
  static const routeName = '/ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaire';
  @override
  State<ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaire> createState() => _ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaireState();
}

class _ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaireState extends State<ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaire> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.getListOfCompetitionsQuestionnaireForConfirmationOfIndependence(provider.yearSelected, widget.committeeId);
      provider.initializeResponseConfirmationOfIndependenceControllers();
    });
  }
      ...
      if (provider.isBack) {
        Future.delayed(Duration(seconds: 2), () {
          if (Navigator.canPop(context)) {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => ConfirmationOfIndependenceCompetitionsQuestionsMemberQuestionnaire(committeeId: widget.committeeId)));
                  ...
                  child: Form(
                    ...
                    child: Consumer<CompetitionProviderPage>(
                      builder: (context, provider, child) {
                        ...
                        if (provider.competitionsConfirmationOfIndependenceData!.competitions!.isEmpty) {
                          return Center(
                            child: CustomText(
                        ...
                        if (provider.textResponses.isEmpty) {
                          for (int i = 0; i < provider.competitionsConfirmationOfIndependenceData!.competitions!.length; i++) {
                            final competition = provider.competitionsConfirmationOfIndependenceData!.competitions![i];
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemCount: provider.competitionsConfirmationOfIndependenceData!.competitions!.length,
                              itemBuilder: (context, index) {
                                CompetitionConfirmationOfIndependenceModel question = provider.competitionsConfirmationOfIndependenceData!.competitions![index];
