...
class _CommitteeEventEditingPageState extends State<CommitteeEventEditingPage> {
  final _formCommitteeKey = GlobalKey<FormState>();
      ...
      child: Stepper(
          ...
          return Row(
            children: <Widget>[
              TextButton(
                ...
                child: CustomText(text:'Next',color: Colors.white,fontWeight: FontWeight.bold),
              ),
        ...
        steps: <Step>[
          Step(
            ...
            isActive: _index >= 0,
            title: CustomText(text: 'meeting content'),
            content: Column(
           ...
           Step(
            ...
            isActive: _index >= 1,
            title: CustomText(text:'agenda content'),
            content: Column(
              children: [
                 buildAddButton(),
    ...
    return StatefulBuilder(
        builder: (BuildContext context, StateSetter setState) {
          return AlertDialog(
            ...
            title: CustomText(text:"Signature Request Deloitte Audit Committee Practices.PDF",color: Colors.red,fontSize: 20, fontWeight: FontWeight.bold),
            content: SizedBox(
              width: 600,
              child: Form(
  ...
  List<Widget> buildEditingActions() => [
    ElevatedButton.icon(
      ...
      onPressed: saveForm,
      icon: CustomIcon(icon:Icons.done),
      label: CustomText(text:'Save'),
    )
  ];
  ...
  Widget buildCommitteeDropdown() => Container(
    ...
    child: DropdownButtonHideUnderline(
      child: DropdownButton(
        ...
        hint: CustomText(text:"Select an Committee",color: Colors.white),
        ...
        items:[
           DropdownMenuItem(
            value: "",
            child: CustomText(text:"Select an Committee",color: Colors.white),
          ),
  ...
  Future saveForm() async {
    ...
    final isValid = _formCommitteeKey.currentState!.validate();
    if(isValid){
