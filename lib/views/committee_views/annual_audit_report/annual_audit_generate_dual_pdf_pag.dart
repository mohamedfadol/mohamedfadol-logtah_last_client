...
class AnnualAuditGenerateForDualPdfPag extends material.StatefulWidget {

  final AnnualAuditReportModel annual_report;
  const AnnualAuditGenerateForDualPdfPag({super.key, required this.annual_report});
  static const routeName = '/AnnualAuditGenerateForDualPdfPag';


  @override
  material.State<AnnualAuditGenerateForDualPdfPag> createState() => _AnnualAuditGenerateForDualPdfPagState();
}

class _AnnualAuditGenerateForDualPdfPagState extends material.State<AnnualAuditGenerateForDualPdfPag> {
