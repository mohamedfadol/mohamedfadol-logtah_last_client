...
class PreviewPdfFileForSearchableText extends StatefulWidget {
  final String file;
  final String fileName;
  final String searchText;
  const PreviewPdfFileForSearchableText({super.key,required this.file,required this.fileName, this.searchText = ""});

  @override
  State<PreviewPdfFileForSearchableText> createState() => _PreviewPdfFileForSearchableTextState();
}

class _PreviewPdfFileForSearchableTextState extends State<PreviewPdfFileForSearchableText> {
  bool loading = true;
  ...
  void initState() {
    ...
    // Delayed execution to wait until the build method is complete
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.searchText.isNotEmpty) {
        setState(() {
          _showToolbar = true; // Show the toolbar to display the search results
        });
        _pdfViewerController.searchText(widget.searchText);
      }
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          loading ? Center(child: CircularProgressIndicator(),) : SfPdfViewer.network(
            widget.file!,
