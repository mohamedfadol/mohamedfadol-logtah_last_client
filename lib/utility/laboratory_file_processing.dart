    ...
    try {
          if(await PDFApi.requestPermission()){
            ...
            final memberProvider = Provider.of<MemberPageProvider>(context, listen: false);
              ...
              final pdfFile = await PdfFileProcessingClass.ReplaceImageByIndexOfPageFromNetWorkPath(imagePath.path, laboratoryProvider.indexing, laboratoryProvider.totalPagesOfFile!, widget.path!);
             ...
             List<Map<String, dynamic>> canvsItemData = laboratoryProvider.canvasItemsList.map((canvasItem) => canvasItem.toMap()).toList();
